...
@Table(name = "vw_memberactivitydesc")
public class VwMemberactivitydesc {
     ...
     * @param destmemberid
     */
    public void setDestmemberid(Byte destmemberid) {
